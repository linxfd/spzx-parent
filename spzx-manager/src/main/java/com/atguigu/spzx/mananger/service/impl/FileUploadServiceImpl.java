...
import com.atguigu.spzx.mananger.config.MinioProperties;
    ...
    public String fileUpload(MultipartFile file) {
        try {
            ...
            PutObjectArgs putObjectArgs = PutObjectArgs.builder()
                    ...
                    //-1 这是可选的，代表分块上传的大小。如果设置了分块大小（且大于 0），则 SDK 会使用分块上传的方式来上传文件。这通常用于大文件上传，以提高上传的可靠性和效率。
